...
/* NOTE(levi):
 * Holy fuck is this whole thing disgusting. This almost looks as bad as
 * minified JS. I've done minimal formatting, so I take no responsibility for
 * this. Thankfully we only really need it for running the TINY pseudo asm that
 * we produce, so we need not concern ourselves with it.
 */
...
[[noreturn]] /* NOTE(levi): I added this to make g++ not complain */
